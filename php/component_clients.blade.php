<section class="abouts-clients-new  container">
    ...
    <div class="grid-imagens">
        <div class="image -vertical">
            ...
            <img src="{{ $banner_home_colecao->banners_clientes_home->values->first()->source }}" loading="lazy" data-bs-toggle="modal"
    ...
    <div class="grid-imagens-mobile swiper-default carrousel-clients">
        <div class="swiper-wrapper">
            ...
            <div class="item swiper-slide">
                <div class="image -vertical">
                    <img src="{{ $banner_home_colecao->imagem_mobile_banners_clientes->values->first()->source }}" loading="lazy"
...
<div class="modal fade" id="modal{{ $banner_home_colecao->ordem_banners_clientes->values->first()->extraFieldOption->label  }}" tabindex="-1" aria-labelledby="modalLabel{{ $banner_home_colecao->ordem_banners_clientes->values->first()->extraFieldOption->label  }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content modal-clients">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="image">
                                    ...
                                    <img src="{{ $banner_home_colecao->galeria_1_banners_clientes->values->first()->source }}" alt="{{ $banner_home_colecao->titulo_banners_clientes->values->first()->value  }}" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image">
                                    <img src="{{ $banner_home_colecao->galeria_2_banners_clientes->values->first()->source }}" alt="{{ $banner_home_colecao->titulo_banners_clientes->values->first()->value  }} 2" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="image">
                                    <img src="{{ $banner_home_colecao->galeria_3_banners_clientes->values->first()->source }}" alt="{{ $banner_home_colecao->titulo_banners_clientes->values->first()->value  }} 3" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide grid-imagens">
                                <div class="image -vertical" data-index="0">
                                    <img src="{{ $banner_home_colecao->galeria_1_banners_clientes->values->first()->source }}" alt="{{ $banner_home_colecao->titulo_banners_clientes->values->first()->value  }} 1" class="img-fluid">
                                </div>
                            </div>
                            <div class="swiper-slide grid-imagens">
            ...
            <div class="modal-content-text">
                <div class="modal-title fs-5" id="modalLabel1">{{ $banner_home_colecao->titulo_banners_clientes->values->first()->value }}</div>
                <div class="content-text">
                    @if($banner_home_colecao->descricao_banners_clientes != null && $banner_home_colecao->descricao_banners_clientes->values->isNotEmpty())
                    <p>{!! $banner_home_colecao->descricao_banners_clientes->values->first()->value !!}</p>
                    @else
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p> <!-- Ou pode exibir algo como texto padrão aqui -->
                    @endif
...
<path d="M18 6L6 18M6 6L18 18" stroke="#B0B0B0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="content-bottom">
                    <a href="{{ $banner_home_colecao->link_da_joia_banners_clientes->values->first()->value  }}">Conheça o anel de noivado</a>
                </div>
            </div>
        </div>
    </div>
