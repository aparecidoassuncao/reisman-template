<nav id="menu-mobile" class="menu-mobile-aside">
    <div class="logo-menu">
        <div class="logo">
            <img src="{{ path('logo-novo-preto.svg') }}" width="130px" height="25px" alt="Logo Reisman Mobile Alianças e Joias">
        </div>
    ...
    <div class="mm-menu-search">
        <form class="search-form" action="/busca" method="get" id="search-form1">
            ...
            <div class="field">
                    ...
                    <input type="search" autocomplete="off" class="form-control" name="term" id="term1" placeholder="O que você procura?" required autocomplete="on">
