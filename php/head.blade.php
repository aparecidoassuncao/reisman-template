...
@if(starts_with(request()->path(), '/'))
  <meta name="description" content="Alianças de Casamento e anéis de noivado é com a Reisman! Os mais lindos modelos, com preço justo e alta qualidade. Clique e confira!">
@else
