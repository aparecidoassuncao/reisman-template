...
<link rel="stylesheet" href="https://use.typekit.net/xho6dxr.css">
 <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
  ...
  <meta property="og:image" content="@if($produto->extraFields->has('imagem_produto_01')) {{ $produto->extraFields->get('imagem_produto_01')->values->first()->source }} @else https://assets.betalabs.net/production/reisman/images/stores/1/reisman-logo.jpeg @endif ">
