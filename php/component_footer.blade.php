                        ...
                        @foreach($infosfooter->records as $infof)  
                            @if($infof->whatsapp != null)
                                <div class="div-footer-atendimento">
                                    ...
                                    <img alt="Ícone do Whatsapp" src="{{ path('icon-whatsapp.svg') }}"> <span id="n-whats">{{ $infof->whatsapp->values->first->value->value }}</span>
                                    </a>
                                </div>
                            ...
                            @if($infof->telefone != null)
                                <div class="div-footer-atendimento">
                                    <a href="/contato">
                                    <img alt="Ícone do atendimento" src="{{ path('icon-atendimento.svg') }}"> {{ $infof->telefone->values->first->value->value }}
                                    </a>
                                </div>
                            @endif
                        @endforeach    
        ...
        <div class="form-newsletter">
            ...
            <div class=" footer-submit-wrapper">
				<form action="#" class="d-flex mb-0 w-100">
					<input type="email" class="form-control mb-0 email-newsletter" placeholder="Seu e-mail" required="">
