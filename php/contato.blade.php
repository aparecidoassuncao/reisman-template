        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <p>Caso precise acionar nosso suporte para tratar de qualquer assunto referente a sua joia, por gentileza utilize nosso <a href="/suporte">formulário de suporte.</a></p>
                    <p>Estamos prontos para auxiliar no que precisar</p>
                    <h4 class="mt-4">telefone</h4>
                    <p>Ligue para: (11) 3567-0617 ou <a href="https://wa.me/5511959646000" target="_blank">WhatsApp: (11) 9 5964-6000</a></p>
                    ...
                    <form class="form-contato" onsubmit="return submitUserForm();">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LdlesQUAAAAAKZwLBGMamzNTTs5nt5lixMRkM8l" data-callback="verifyCaptcha"></div>
