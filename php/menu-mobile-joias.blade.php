<li>
    <a href="#" class="open-submenu"> Joias </a>
    <div class="submenu">
        ...
        <ul>
            <li>
                <h2 class="accordion-toggle">Anéis de formatura</h2>
            ...
            <li>
                <h2 class="accordion-toggle">Brincos</h2>
                <div class="accordion-content">
                    <div class="item-menu">
            ...
            <li>
                <h2 class="accordion-toggle">Anel de 15 anos</h2>
                <div class="accordion-content">
                    <div class="item-menu">
            ...
            <li>
                <h2 class="accordion-toggle">Aparadores</h2>
                <div class="accordion-content">
