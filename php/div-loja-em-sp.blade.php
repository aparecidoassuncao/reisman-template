@if($lojaemsp->records->count() > 0)
  @foreach($lojaemsp->records as $divloja)
    <div id="div-loja-sp" data-aos="fade-zoom-in"
     ...
     data-aos-duration="800">
      <div class="div-inner">
        ...
        <a @if($divloja->link_botao != null) href="{{ $divloja->link_botao->values->first->value->value }}" @endif class="btn btn-ver-mais desktop-inline-item">
      ...
      @endif
      @if($divloja->texto_botao != null)
      <a @if($divloja->link_botao != null) href="{{ $divloja->link_botao->values->first->value->value }}" @endif class="btn btn-ver-mais mobile-item">
        {{ $divloja->texto_botao->values->first->value->value }}
      </a>
      @endif
    </div>
