                                ...
                                <div class="faq-content">
                                    <div class="faq-item">
                                            ...
                                            <div class="faq-answer" hidden>
                                               Não existe uma única "melhor", mas sim a ideal para o seu orçamento. A maioria dos especialistas recomenda a faixa "Near Colorless" (G a J). Essas pedras parecem brancas a olho nu quando montadas no anel, mas custam significativamente menos que as da faixa "Colorless" (D-F), permitindo que você invista mais no peso (Quilates) ou no Corte.
                                            </div>
                                    </div>
                                </div>
                                <div class="faq-content">
...
<path d="M4 6L8 10L12 6" stroke="#1E1613" stroke-linecap="round" stroke-linejoin="round"/>
                                            ...
                                            <div class="faq-answer" hidden>
                                               Existe uma distinção sutil, mas poderosa. Embora diamantes da categoria G sejam bonitos, um diamante de cor D (Totalmente Incolor) possui uma transparência "gélida" e cristalina incomparável. Lado a lado, nota-se que o diamante D entrega um branco mais frio, nítido e puro. Optar por cores D, E ou F é garantir que sua joia ostente a perfeição máxima de ausência de cor, algo que traz um brilho psicológico e estético de que você possui o que há de mais raro na natureza.
                                            </div>
                                    </div>
                                </div>
                                <div class="faq-content">
                                    <div class="faq-item">
                                            <button class="faq-question" aria-expanded="false">
                                                <span>A cor do metal (Ouro Branco vs Amarelo) influencia na escolha da cor do diamante?</span>
                                                <span class="faq-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4 6L8 10L12 6" stroke="#1E1613" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</span>
                                            ...
                                            <div class="faq-answer" hidden>
                                             Ouro Branco: Como o metal é branco, ele reflete na pedra. Recomenda-se cores mais altas (H ou superior) para evitar que a pedra pareça amarelada.



Ouro Amarelo ou Rosé: O metal transfere cor para a pedra. Você pode descer na escala (I, J ou até K) sem prejuízo estético, pois o tom do metal mascara o leve tom da pedra, gerando grande economia.
                                            </div>
                                    </div>
                                </div>
                                <div class="faq-content">
...
<path d="M4 6L8 10L12 6" stroke="#1E1613" stroke-linecap="round" stroke-linejoin="round"/>
                                            ...
                                            <div class="faq-answer" hidden>
                                                É uma questão de raridade geológica! Diamantes totalmente livres de nitrogênio (o elemento que causa o tom amarelo) são extremamente raros na natureza. O preço reflete essa exclusividade.
                                            </div>
                                    </div>
                                </div>
                                <div class="faq-content">
                                    <div class="faq-item">
                                        ...
                                        A escala começa na letra D (Totalmente Incolor) e vai até Z (Levemente Amarelado ou Marrom).
                                ...
                                <div class="faq-content">
                                       <div class="faq-item">
                                            ...
                                            <div class="faq-answer" hidden>
                                              Não. O brilho é determinado principalmente pelo Corte (Cut), não pela cor. Um diamante cor K com um corte "Excelente" brilhará muito mais do que um diamante cor D com um corte "Pobre". Nunca sacrifique a qualidade do corte pela cor.
                                            </div>
                                    </div>
                                </div>
                                 <div class="faq-content">
                                       <div class="faq-item">
                                            ...
                                            <div class="faq-answer" hidden>
                                           Para a maioria dos compradores, os diamantes de cor G ou H são o "sweet spot" (ponto ideal). Eles oferecem uma aparência branca e limpa idêntica aos graus superiores a olho nu, mas sem o preço premium da raridade das cores D, E ou F.
                                            </div>
                                    </div>
                                </div>
                        </div>
