<div class="canopus-cart-container d-flex justify-content-between flex-column">
    ...
    <div class="canopus-cart-modal-bottom">
          ...
          <div id="div-observacao" class="">
                  ...
                  <div class="content">
                    <input id="input-gravacao-pedido" type="text"  name="observacao" class="form-control" placeholder="Digite aqui caso tenha alguma observação ">
...
.canopus-cart-item-extra-fields.item-personalizacao li.gravacao_masculina div:last-child::before , .canopus-cart-item-extra-fields.item-personalizacao li.gravacao_feminina div:last-child::before , .canopus-cart-item-extra-fields.item-personalizacao li.gravacao_interna div:last-child::before{
    content: '-';
    margin-right: 5px;
}
