<section class="middle-home">
    <h3>Prepare-se para o "Sim" mais lindo da sua vida</h3>
    <div class="content-middle">
        <div class="context-img image -vertical">
            <img src="https://assets.betalabs.net/production/reisman/images/stores/1/img-middle.png">
        </div>
