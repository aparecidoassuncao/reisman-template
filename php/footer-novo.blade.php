@section('footer')
        ...
        <footer id="footer">
          <div class="div-footer">
            ...
            <div class="div-inner-footer">
              ...
              <div class="subtitle-footer">
                <a @if($linkblogfooter->link_materia_blog_footer != null) href="{{ $linkblogfooter->link_materia_blog_footer->values->first->value->value }}" @endif>
          ...
          <div class="div-footer bg-gray">
                ...
                <div class="subtitle-footer">
                  ...
                  <div class="div-footer-atendimento">
                    <a href="" target="_blank" id="a-whats">
                      <img src="{{ path('icon-whatsapp.svg') }}" alt="whatsapp atendimento"> <span id="n-whats">{{ $infof->whatsapp->values->first->value->value }}</span>
                    </a>
                  </div>
                    @push('scripts')
                    <script>
                        ...
                        numeroWhats = numeroWhats.replace('(', '').replace(')', '').replace(' ', '').replace('-', '');
                  ...
                  <div class="div-footer-atendimento">
                    <a href="/contato">
                      <img src="{{ path('icon-atendimento.svg') }}" alt="atendimento"> {{ $infof->telefone->values->first->value->value }}
                    </a>
                  </div>
                  @endif
                </div>
            ...
            <div class="div-inner-footer">
                ...
                <img src="{{ path('img-pagamento.png') }}">
            </div>
            <div class="div-inner-footer">
                <div class="title-footer">
                  Segurança
          ...
          <div class="div-bottom-footer">
            <div class="subtitle-footer">
              @if($infof->nome_fantasia != null){{ $infof->nome_fantasia->values->first->value->value }} <span class="desktop-inline-item">·</span><br class="mobile-item" /> @endif @if($infof->cnpj != null) CNPJ: {{ $infof->cnpj->values->first->value->value }}@endif
            </div>
          ...
          <div id="div-dev-footer" class="div-bottom-footer">
            <a href="" target="_blank" alt="Plataforma E-commerce">
  ...
  <div class="alert alert-dismissible text-center cookiealert" role="alert">
    <div class="cookiealert-container">
        <b>
            Coletamos dados estatísticos para melhorar sua experiência de navegação no site. Ao continuar, você concorda com nossa <a href="/politica-de-privacidade" target="_blank">política de privacidade</a>.
        </b>
  ...
  <a class="wppButton" href="https://api.whatsapp.com/send?phone=5511959646000&text=Ol%C3%A1,%20vim%20atrav%C3%A9s%20do%20site" target="_blank"></a>
