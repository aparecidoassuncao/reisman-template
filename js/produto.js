...
function _unsupportedIterableToArray(e, t) {
    if (e) {
        ...
        return "Object" === o && e.constructor && (o = e.constructor.name), 
               "Map" === o || "Set" === o ? Array.from(e) : 
               "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? 
               _arrayLikeToArray(e, t) : void 0
    }
}
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            $.each(e.data, function(e, o) {
                ...
                t = '<li><i class="fa fa-truck" aria-hidden="true"></i>' + 
                    o.description.replace(":", "") + "<br> R$ " + 
...
function changePrice() {
    ...
    var i = parseFloat(priceNumber) / .6,
    ...
    $("div#priceProduto").html("<p>R$ " + o + " no pix " + a + ' <span class="flag">promoção<span></p> <p>ou <b>10x R$ ' + t + "</b> no cartão</p> ");
...
CanopusEventCenter.addListener("Checkout.Preview.Built", function() {
    ...
    var i = function(e, t, i) {
        $.get("/checkout/cart/" + t + "/remove/" + e)
            .done(function() {
                $('.canopus-cart-items ul li[data-id="' + e + '"][data-type="' + t + '"]').remove();
                o(i);
            })
            .fail(function() {});
    };
    ...
    $("#btn-clear-cart").click(function() {
        var e, t = [],
            i = _createForOfIteratorHelper($(".canopus-cart-items ul li.cart-item-row"));
        try {
            for (i.s(); !(e = i.n()).done;) {
                var r = e.value,
    ...
    $("#btn-load-freight-options").click(function() {
        var e = Inputmask.unmask($("#input-cep-freight-options").val(), "99999-999");
        if (8 === e.length) {
            $.get("/ecommerce/zip-code-ranges?zip_code=" + e)
                .done(function(e) {
                    var t, o = $(".container-frete-preview ul"),
                    ...
                    try {
                        for (i.s(); !(t = i.n()).done;) {
                            ...
                            a.html('<i class="fa fa-truck" aria-hidden="true"></i>' + 
                                   '<span class="description">' + r.description + "</span>" + 
                                   '<span class="amount">R$ ' + r.amount.toLocaleString("pt-BR", {
                                       maximumFractionDigits: 2,
                                       minimumFractionDigits: 2
                                   }) + "</span>" + 
                                   '<span class="time-cost">de ' + s + "</span>" + 
                                   '<span class="time-cost-join">a</span>' + 
                                   '<span class="time-cost-limit">' + n + "</span>" + 
...
CanopusEventCenter.addListener("ServerDataLoader.Loaded", function(e) {
    $(".cart-subtotal").html("R$ " + e.cart.subtotal.toLocaleString("pt-BR", {
        maximumFractionDigits: 2,
        minimumFractionDigits: 2
    }));
    $(".container-frete-preview ul").html("");
...
$(document).ready(function() {
    ...
    setInterval(function() {
        if ($(".checkout-cart-preview .canopus-cart-items ul li .canopus-cart-item-image").length > 0) {
            $(".checkout-cart-preview #div-observacao").removeClass("hide");
            $(".frete-wrapper.modal-subtotal.modal-preview-bottom-item").removeClass("hide");
        }
    }, 1000);
    ...
    if ($('#linkWebstorie').length && !$('#linkWebstorie').hasClass('slick-initialized')) {
  $('#linkWebstorie').slick({
    dots: false,
    arrows: false,
    infinite: false,
...
function rodarScriptAddCarrinho(e) {
    ...
    if (e > 0) {
        ...
        $(".coluna-spot-category.carregou-" + e).first().attr("id", "carregou");
...
$(".slick-prev").each(function() {
    ...
    e.attr("src", "https://assets.betalabs.net/production/reisman/images/stores/1/arrow-left.png");
    $(this).append(e);
});
...
$(".slick-next").each(function() {
    $(this).html("");
    var e = $(document.createElement("img"));
    e.attr("src", "https://assets.betalabs.net/production/reisman/images/stores/1/arrow-right.png");
    $(this).append(e);
});
