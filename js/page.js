document.addEventListener("DOMContentLoaded", () => {
    ...
    function toggleSearchBox() {
       const openSearchBox = document.querySelector('header .aside-box .item.search');
       const closeSearchBox = document.querySelector('.header-search button.close-seach');


       openSearchBox.addEventListener('click', () => {
         document.querySelector('.header-search').classList.add('active');
         const searchInput = document.querySelector('.header-search .header-search-wrapper .form-control');
         searchInput.focus();
       });
